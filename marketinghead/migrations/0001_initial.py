...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_month', models.DateField(validators=[marketinghead.models.present_or_future_date])),
                ('end_month', models.DateField(validators=[marketinghead.models.present_or_future_date])),
